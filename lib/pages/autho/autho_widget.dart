...
class _AuthoWidgetState extends State<AuthoWidget>
    with TickerProviderStateMixin {
  late AuthoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthoModel());
                              ...
                              Expanded(
                                child: TabBarView(
                                  ...
                                  children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'ku0gvh1o' /* أو يمكنك استخدام حساب جوجل للد... */,
                                                      ),
                                    ...
                                    StreamBuilder<List<OnOEoffRecord>>(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'onejcoy6' /* أو استخدم حساب جوجل للاشتراك */,
                                                                    ),
                                                                    textAlign:
                                                                        TextAlign
                                                                            .center,
