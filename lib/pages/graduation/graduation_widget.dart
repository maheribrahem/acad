...
export 'graduation_model.dart';

class GraduationWidget extends StatefulWidget {
  const GraduationWidget({
    Key? key,
    this.output,
  }) : super(key: key);
  ...
  @override
  _GraduationWidgetState createState() => _GraduationWidgetState();
}

class _GraduationWidgetState extends State<GraduationWidget> {
  late GraduationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GraduationModel());
