...
class CategWidget extends StatefulWidget {
  ...
  @override
  _CategWidgetState createState() => _CategWidgetState();
}

class _CategWidgetState extends State<CategWidget>
    with TickerProviderStateMixin {
  late CategModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategModel());
