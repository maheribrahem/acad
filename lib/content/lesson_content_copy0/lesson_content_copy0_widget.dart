...
import 'lesson_content_copy0_model.dart';
export 'lesson_content_copy0_model.dart';

class LessonContentCopy0Widget extends StatefulWidget {
  const LessonContentCopy0Widget({
    super.key,
  ...
  @override
  _LessonContentCopy0WidgetState createState() =>
      _LessonContentCopy0WidgetState();
}

class _LessonContentCopy0WidgetState extends State<LessonContentCopy0Widget>
    with TickerProviderStateMixin {
  late LessonContentCopy0Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LessonContentCopy0Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ActivitiesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final lessonContentCopy0ActivitiesRecord = snapshot.data!;
        return YoutubeFullScreenWrapper(
          child: Title(
              title: 'lessonContentCopy0',
                                                          ...
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                stream: SupjRecord
                                                                    .getDocument(
                                                                        lessonContentCopy0ActivitiesRecord
                                                                            .supjRef!),
                                                                builder: (context,
                                                                    snapshot) {
                                                                  // Customize what your widget looks like when it's loading.
                                                                        ...
                                                                        child: StreamBuilder<
                                                                          ...
                                                                          stream:
                                                                            ...
                                                                            queryBuilder: (activitiesRecord) => activitiesRecord
                                                                                .where(
                                                                                  'supjRef',
                                                                                  isEqualTo: lessonContentCopy0ActivitiesRecord.supjRef,
                                                                                )
                                                                                .where(
                                                                                  'order',
                                                                                  isEqualTo: functions.decrementOrder(lessonContentCopy0ActivitiesRecord.order),
                                                                                ),
                                                                            singleRecord:
                                                                                true,
                                                                          ),
                                                                      ...
                                                                      FutureBuilder<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          int textCount =
                                                                              snapshot.data!;
                                                                          return Text(
                                                                            '${lessonContentCopy0ActivitiesRecord.order.toString()} من ${textCount.toString()}',
                                                                            style:
                                                                      ...
                                                                      FutureBuilder<
                                                                        ...
                                                                        future:
                                                                          ...
                                                                          queryBuilder: (activitiesRecord) =>
                                                                            ...
                                                                            'supjRef',
                                                                            isEqualTo:
                                                                                lessonContentCopy0ActivitiesRecord.supjRef,
                                                                          ),
                                                                        ),
                                                                        builder:
                                                                            (context,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              stream: queryActivitiesRecord(
                                                                                queryBuilder: (activitiesRecord) => activitiesRecord
                                                                                    ...
                                                                                    .where(
                                                                                      'order',
                                                                                      isEqualTo: functions.incrementOrder(lessonContentCopy0ActivitiesRecord.order),
                                                                                    ),
                                                                                singleRecord: true,
                                                                              ),
                                                                              builder: (context, snapshot) {
                                                                ...
                                                                Row(
                                                                  ...
                                                                  mainAxisAlignment:
                                                                      MainAxisAlignment
                                                                          .center,
                                                                  children: [
                                                                    if (lessonContentCopy0ActivitiesRecord.video !=
                                                                            '')
                                                                      Icon(
                                                                        Icons
                                                                            .ondemand_video,
                                                                    ...
                                                                    if (lessonContentCopy0ActivitiesRecord.audio !=
                                                                            '')
                                                                      Icon(
                                                                        Icons
                                                                            .graphic_eq,
                                                                      ...
                                                                      Material(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            url:
                                                                                lessonContentCopy0ActivitiesRecord.video,
                                                                            autoPlay:
                                                                                false,
                                                                            looping:
                                                                                false,
                                                                                                    ...
                                                                                                    Padding(
                                                                                                      ...
                                                                                                      child: Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          Text(
                                                                                                            'رقم الدرس: ${lessonContentCopy0ActivitiesRecord.order.toString()}',
                                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                                  fontFamily: 'Cairo',
                                                                                                                  fontWeight: FontWeight.bold,
                                                                                                                ),
                                                                                                    ...
                                                                                                    Padding(
                                                                                                      ...
                                                                                                      child: Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          Text(
                                                                                                            'اسم الدرس : ${lessonContentCopy0ActivitiesRecord.name}',
                                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                                  fontFamily: 'Cairo',
                                                                                                                  fontWeight: FontWeight.bold,
                                                                                                                ),
                                                                                                    ...
                                                                                                    Padding(
                                                                                                      ...
                                                                                                      child: Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          Text(
                                                                                                            'شرح : ${lessonContentCopy0ActivitiesRecord.teacher}',
                                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                                  fontFamily: 'Cairo',
                                                                                                                  fontWeight: FontWeight.bold,
                                                                                                                ),
                                                                                                    ...
                                                                                                    Padding(
                                                                                                      ...
                                                                                                      child: Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          Text(
                                                                                                            'وصف : ${lessonContentCopy0ActivitiesRecord.description}',
                                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                                  fontFamily: 'Cairo',
                                                                                                                  fontWeight: FontWeight.bold,
                                                                                                                ),
                                                                                                          ...
                                                                                                          future: (_model.requestCompleter ??= Completer<List<ActivitiesProgressRow>>()
                                                                                                                ..complete(ActivitiesProgressTable().queryRows(
                                                                                                                  queryFn: (q) => q
                                                                                                                      .eq(
                                                                                                                        'activitID',
                                                                                                                        lessonContentCopy0ActivitiesRecord.reference.id,
                                                                                                                      )
                                                                                                                      .eq(
                                                                                                                        'userID',
                                                                                                                        currentUserReference?.id,
                                                                                                                      ...
                                                                                                                      if (containerAttendActivitiesProgressRowList.isNotEmpty) {
                                                                                                                        if (containerAttendActivitiesProgressRowList.first.isAttended!) {
                                                                                                                          await ActivitiesProgressTable().update(
                                                                                                                            data: {
                                                                                                                              'isAttended': false,
                                                                                                                              'activitID': lessonContentCopy0ActivitiesRecord.reference.id,
                                                                                                                              'supjID': lessonContentCopy0ActivitiesRecord.supjRef?.id,
                                                                            ...
                                                                            builder: (context) =>
                                                                              ...
                                                                              stream: queryActivitiesRecord(
                                                                                queryBuilder: (activitiesRecord) => activitiesRecord
                                                                                    ...
                                                                                    .where(
                                                                                      'order',
                                                                                      isEqualTo: lessonContentCopy0ActivitiesRecord.order,
                                                                                    )
                                                                                    .where(
                                                                                      'visibility',
                                                                                      isEqualTo: true,
