...
import 'test_content_copy_model.dart';
export 'test_content_copy_model.dart';

class TestContentCopyWidget extends StatefulWidget {
  const TestContentCopyWidget({
    super.key,
  ...
  @override
  _TestContentCopyWidgetState createState() => _TestContentCopyWidgetState();
}

class _TestContentCopyWidgetState extends State<TestContentCopyWidget> {
  late TestContentCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TestContentCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ActivitiesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final testContentCopyActivitiesRecord = snapshot.data!;
        return Title(
            title: 'testContentCopy',
                ...
                body: FutureBuilder<List<ActivitiesProgressRow>>(
                  future: ActivitiesProgressTable().queryRows(
                    queryFn: (q) => q
                        ...
                        .eq(
                          'activitID',
                          testContentCopyActivitiesRecord.reference.id,
                        )
                        .eq(
                          'userID',
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Container(
                      ...
                      child: FutureBuilder<List<CategGradesRow>>(
                                                                                  ...
                                                                                  onTap: () async {
                                                                                    ...
                                                                                    if (confirmDialogResponse) {
                                                                                      await ActivitiesProgressTable().insert({
                                                                                        ...
                                                                                        'isDone': true,
                                                                                        'isSeen': true,
                                                                                        'supjID': testContentCopyActivitiesRecord.supjRef?.id,
                                                                                        'type': 'test',
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            if (!testContentCopyActivitiesRecord.isFinal)
                                                                              InkWell(
                                                                                splashColor: Colors.transparent,
                                                                                focusColor: Colors.transparent,
                                                                                hoverColor: Colors.transparent,
                                                                                          ...
                                                                                          child: Container(
                                                                                            ...
                                                                                            child: wrapWithModel(
                                                                                              ...
                                                                                              child: QbankAnswerCopyWidget(
                                                                                                key: Key(
                                                                                                  'Key7n5_${qbankQbankRecord.reference.id}',
                                                                                                ),
                                                                                                answer: qbankQbankRecord.answer,
                                                                                                parameter1: qbankQbankRecord.options,
                                                                                                qBankRef: qbankQbankRecord.reference,
