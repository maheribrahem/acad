...
export 'courses_main_p_model.dart';
...
class CoursesMainPWidget extends StatefulWidget {
  ...
  @override
  _CoursesMainPWidgetState createState() => _CoursesMainPWidgetState();
}

class _CoursesMainPWidgetState extends State<CoursesMainPWidget>
    with TickerProviderStateMixin {
  late CoursesMainPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoursesMainPModel());
    ...
    _model.categRefController ??= TextEditingController();
    _model.categRefFocusNode ??= FocusNode();

    _model.supjRefController ??= TextEditingController();
    _model.supjRefFocusNode ??= FocusNode();
                                                                ...
                                                                children: [
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      _model.categRef =
                                                                          offerListCategRecord
                                                                              .reference;
                                                                      setState(
                                                                          () {
                                                                        _model
                                                                            .categRefController
                                                                            ?.text = offerListCategRecord.name;
                                                                      });
                                                                    },
                                                                    child:
                                                                        Material(
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    decoration: BoxDecoration(
                                                                                      ...
                                                                                      image: DecorationImage(
                                                                                        fit: BoxFit.cover,
                                                                                        image: Image.asset(
                                                                                          'assets/images/22896097_6721758.jpg',
                                                                                        ).image,
                                                                                      ),
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode: _model.categRefFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode: _model.supjRefFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
